...
//            jarakberjalan
    ...
    private fun calculateHRMBB(usia: String): BigDecimal?{
        ...
        val hrmbb = BigDecimal("164").subtract((usiaHR.multiply(BigDecimal(0.7))))
    ...
    private fun calculateHrr(hrmbb: String, nadi: String): BigDecimal?{
        ...
        val hrr = hrmbbhr.subtract(nadiHR)
        return hrr
    }
    private fun calculatehrr20(hrr: String,nadi: String): BigDecimal{
        ...
        val hrr20akhir = hrr20.add(BigDecimal(nadi))
        return hrr20akhir
    }
    private fun calculatehrr40(hrr: String,nadi: String): BigDecimal{
        ...
        val hrr40akhir = hrr40.add(BigDecimal(nadi))
        return hrr40akhir
    }
    private fun calculatehrr60(hrr: String ,nadi: String): BigDecimal{
        ...
        val hrr60akhir = hrr60.add(BigDecimal(nadi))
        return hrr60akhir
    }
    private fun calculatehrr80(hrr: String ,nadi: String): BigDecimal{
        ...
        val hrr80akhir = hrr80.add(BigDecimal(nadi))
        return hrr80akhir
    }

    private fun calculateHRMtanpaBB(usia: String): BigDecimal?{
        val usiaHR = BigDecimal(usia)
        val hrmtanpabb = BigDecimal("220").subtract(usiaHR)
    ...
    private fun calculateHrrtanpabb(hrmtanpabb: String, nadi: String): BigDecimal?{
        ...
        val nadiHR = BigDecimal(nadi)
        val hrr = hrmtanpabbhr.subtract(nadiHR)
        return hrr
    }
...
//    Mets
    private fun calculatemets20(mets: String): BigDecimal{
        ...
        val mets20 = ((mets.subtract(BigDecimal("1")).multiply(BigDecimal("0.2"))).add(BigDecimal("1")))
        return mets20
    }
    private fun calculatemets40(mets: String): BigDecimal{
        val mets = BigDecimal(mets)
        val mets40 = ((mets.subtract(BigDecimal("1")).multiply(BigDecimal("0.4"))).add(BigDecimal("1")))
        return mets40
    }
    private fun calculatemets60(mets: String): BigDecimal{
        val mets = BigDecimal(mets)
        val mets60 = ((mets.subtract(BigDecimal("1")).multiply(BigDecimal("0.6"))).add(BigDecimal("1")))
        return mets60
    }
//      v02
    private fun calculatev02(mets: String): BigDecimal{
        val mets = BigDecimal(mets)
        val vo2 = mets.multiply(BigDecimal(3.5))
        return vo2
    }
...
// speed
    private fun calculatespeed(vo: String): BigDecimal{
        ...
        val speed = ((vo.subtract(BigDecimal("3.5"))).divide(BigDecimal("0.1")))
        return speed
    }
...
//    jarak
    private fun calculatejarakberjalan(speed: String): BigDecimal{
        ...
        val jarak = speed.multiply(BigDecimal("30"))
        return jarak
    }
